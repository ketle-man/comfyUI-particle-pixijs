...
フィルターライブラリの **Texture & Rotation** から設定します。

- **Select File** — 任意の画像ファイルをパーティクルテクスチャとして読み込む
- **× Default** — デフォルト（グラデーション円形）に戻す
- **Rotation Angle** — 固定の回転角度（0〜360°）
- **Random Rotation** — パーティクルごとにランダムな回転を付与
